...
VOID VendorIdAndMaxBasicFunction(IN UINT32 *gMaxBasicFunc)
{
...
VOID CpuidFeatureInfo(IN UINT32 gMaxBasicFunc)
{
...
VOID CpuidExtendedFunction(IN UINT32 *gMaxExtendedFunc)
{
  UINT32 Eax;
...
VOID CpuidProcessorBrandString(IN UINT32 gMaxExtendedFunc)
{
...
EFI_STATUS EFIAPI UefiMain(IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
  ...
  CpuidFeatureInfo(gMaxBasicFunc);
  CpuidExtendedFunction(&gMaxExtendedFunc);
  CpuidProcessorBrandString(gMaxExtendedFunc);
