...
set BASETOOLS_DIR=D:\E\EDK2\Workspace\BaseTools\Bin\Win32
set BOOTSECTOR_BIN_DIR=D:\E\EDK2\Workspace\DuetPkg\BootSector\bin
set DISK_LABEL=DUET
set PROCESSOR=""
set STEP=1
...
set BUILD_DIR=D:\E\EDK2\Workspace\Build\DuetPkgX64\DEBUG_VS2015x86
...
copy D:\E\EDK2\Workspace\ShellBinPkg\UefiShell\X64\Shell.efi %EFI_BOOT_DISK%\efi\boot\boot%PROCESSOR%.efi /y
echo 8
goto end
