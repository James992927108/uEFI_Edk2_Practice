...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6E851687, 0xA7A9, 0x4aa2, {0x8D, 0xD0, 0x67, 0x3E, 0x03, 0xE5, 0x14, 0x33}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SetSockOpt";
