...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x70FB9CE0, 0x2CB1, 0x4fd7, {0x80, 0xEE, 0xAB, 0x4B, 0x6C, 0xF4, 0xB4, 0x3F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GetHostByName";
