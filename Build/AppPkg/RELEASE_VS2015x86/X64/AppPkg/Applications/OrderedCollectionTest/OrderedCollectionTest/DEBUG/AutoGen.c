...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE6C7EBB7, 0x1604, 0x4FCB, {0x8F, 0x87, 0xB3, 0xA6, 0xF4, 0x87, 0x30, 0xAE}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OrderedCollectionTest";
...
#define _PCD_TOKEN_PcdDebugPrintErrorLevel  22U
#define _PCD_SIZE_PcdDebugPrintErrorLevel 4
#define _PCD_GET_MODE_SIZE_PcdDebugPrintErrorLevel  _PCD_SIZE_PcdDebugPrintErrorLevel 
#define _PCD_VALUE_PcdDebugPrintErrorLevel  0x80400040U
...
#define _PCD_TOKEN_PcdDebugClearMemoryValue  23U
...
#define _PCD_TOKEN_PcdFixedDebugPrintErrorLevel  24U
...
#define _PCD_TOKEN_PcdValidateOrderedCollection  25U
...
#define _PCD_VALUE_PcdValidateOrderedCollection  ((BOOLEAN)1U)
  ...
  )
{
  ...
  Status = __ctor_DevShell (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  Status = __dtor_DevShell (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
