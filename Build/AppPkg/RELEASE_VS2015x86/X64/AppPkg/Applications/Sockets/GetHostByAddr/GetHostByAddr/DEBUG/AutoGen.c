...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC31A6189, 0x639A, 0x458b, {0xB0, 0x40, 0xD7, 0xD5, 0x06, 0xCA, 0x8F, 0x4F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GetHostByAddr";
