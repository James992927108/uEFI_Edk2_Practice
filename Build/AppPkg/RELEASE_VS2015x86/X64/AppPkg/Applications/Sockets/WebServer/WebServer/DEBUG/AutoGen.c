...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x99E87DCF, 0x6162, 0x40c5, {0x9F, 0xA1, 0x32, 0x11, 0x1F, 0x51, 0x97, 0xF7}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "WebServer";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAppPkgTokenSpaceGuid = { 0xe7e1efa6, 0x7607, 0x4a78, { 0xa7, 0xdd, 0x43, 0xe4, 0xbd, 0x72, 0xc0, 0x99 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_WebServer_HttpPort = _PCD_VALUE_WebServer_HttpPort;
...
#define _PCD_TOKEN_PcdCpuNumberOfReservedVariableMtrrs  28U
