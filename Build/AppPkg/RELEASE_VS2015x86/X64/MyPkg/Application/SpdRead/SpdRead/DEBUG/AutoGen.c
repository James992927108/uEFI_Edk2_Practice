...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9B09C366, 0x18E5, 0x49d4, {0xBA, 0xC5, 0x44, 0x4E, 0xF4, 0xDD, 0x16, 0x11}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MySpdRead";
...
#define _PCD_TOKEN_PcdShellIncludeNtGuids  16U
